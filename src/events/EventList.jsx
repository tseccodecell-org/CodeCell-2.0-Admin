    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="flex-1 p-8">
        {filtered.length === 0 ? (
          <div className="bg-white rounded-lg border border-slate-200 flex flex-col items-center justify-center py-24 text-slate-400 gap-3">
            ...
            <button
              onClick={() => setShowCreate(true)}
              className="mt-1 text-sm font-semibold text-slate-600 hover:text-slate-900"
            >
            ...
            {filtered.map(ev => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-lg border border-slate-200 p-5 flex flex-col gap-3.5 cursor-pointer hover:border-slate-300 hover:shadow-sm group"
                >
                  <div className="flex items-start justify-between gap-2">
                    <h3 className="text-sm font-bold text-slate-900 leading-snug group-hover:text-slate-700">
                      {ev.title}
                    </h3>
                  ...
                  >
                    {(ev.status === 'upcoming' || !ev.status) && (
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 text-xs font-semibold py-1.5 rounded-lg text-slate-500 hover:text-emerald-600 hover:bg-emerald-50"
                      >
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {ev.status === 'live' && (
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 text-xs font-semibold py-1.5 rounded-lg text-slate-500 hover:text-rose-600 hover:bg-rose-50"
                      >
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md border border-slate-200">
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
              ...
              <button onClick={() => setShowCreate(false)} className="p-1.5 rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100">
            ...
            <form onSubmit={handleCreate}>
              ...
              <div className="flex justify-end gap-2 px-6 py-4 border-t border-slate-100 bg-slate-50/50 rounded-b-lg">
                <button
                  type="button"
